...
public class G1_Let's_watch_football {
  public static void main(String args[]) {
    Scanner input = new Scanner(System.in);
    int a = input.nextInt(), b = input.nextInt(), c = input.nextInt();
    double dataNeeded = a*c;
    double dataAvailable = b*c;
    // speed = data / time;
    double speed = Math.ceil((dataNeeded - dataAvailable) / b);
...
public class Main {
    public static void main(String args[]) {
        Scanner input = new Scanner(System.in);
        int speedneeded = input.nextInt(), speedavailable = input.nextInt(), videolength = input.nextInt();
        double dataneeded = speedneeded * videolength;
        // time = ceil function of data / speed
        double timeneeded = Math.ceil(dataneeded / speedavailable);
        int startwatching = (int)timeneeded - videolength;
